...
#include "fix_tspin_npt_kokkos.h"
...
FixTSPINNPTKokkos<DeviceType>::FixTSPINNPTKokkos(LAMMPS *lmp, int narg, char **arg) :
...
namespace LAMMPS_NS {
template class FixTSPINNPTKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class FixTSPINNPTKokkos<LMPHostType>;
#endif
}    // namespace LAMMPS_NS
