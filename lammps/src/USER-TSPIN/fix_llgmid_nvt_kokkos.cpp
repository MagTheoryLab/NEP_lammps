...
#include "fix_llgmid_nvt_kokkos.h"
...
FixLLGMidNVTKokkos<DeviceType>::FixLLGMidNVTKokkos(LAMMPS *lmp, int narg, char **arg) :
    FixLLGMidNHKokkos<DeviceType>(lmp, narg, arg)
{
  this->kokkosable = 1;
...
namespace LAMMPS_NS {
template class FixLLGMidNVTKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class FixLLGMidNVTKokkos<LMPHostType>;
#endif
}    // namespace LAMMPS_NS
