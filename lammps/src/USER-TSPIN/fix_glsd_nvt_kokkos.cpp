...
FixGLSDNVTKokkos<DeviceType>::FixGLSDNVTKokkos(LAMMPS *lmp, int narg, char **arg) :
...
namespace LAMMPS_NS {
template class FixGLSDNVTKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class FixGLSDNVTKokkos<LMPHostType>;
#endif
}    // namespace LAMMPS_NS
