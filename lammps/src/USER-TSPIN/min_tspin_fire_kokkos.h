...
// clang-format off
#ifdef LMP_KOKKOS
MinimizeStyle(tspin/fire/kk,MinTSPINFireKokkos);
MinimizeStyle(tspin/fire/kk/device,MinTSPINFireKokkos);
#endif
// clang-format on
#else

#ifndef LMP_MIN_TSPIN_FIRE_KOKKOS_H
#define LMP_MIN_TSPIN_FIRE_KOKKOS_H
...
class MinTSPINFireKokkos : public MinKokkos {
 public:
  MinTSPINFireKokkos(class LAMMPS *);
  ~MinTSPINFireKokkos() override = default;
  ...
  // These helpers launch Kokkos kernels and must remain public for CUDA
  // extended lambda compilation.
 ...
 private:
  DAT::t_ffloat_1d v_fire;
  DAT::t_ffloat_1d u_fire;
  DAT::t_ffloat_1d g_spin;
  DAT::t_ffloat_1d w_fire;
  DAT::t_ffloat_1d g_rho;
