...
#include "fix_llgmid_npt_kokkos.h"
...
FixLLGMidNPTKokkos<DeviceType>::FixLLGMidNPTKokkos(LAMMPS *lmp, int narg, char **arg) :
...
namespace LAMMPS_NS {
template class FixLLGMidNPTKokkos<LMPDeviceType>;
#ifdef LMP_KOKKOS_GPU
template class FixLLGMidNPTKokkos<LMPHostType>;
#endif
}    // namespace LAMMPS_NS
